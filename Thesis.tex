...
\begin{document}
	...
	Il dataset principale utilizzato nello studio raccoglie misurazioni relative alla qualità dell'aria in numerose stazioni di monitoraggio presenti in 453 città indiane per il periodo temporale 2010-2023. Le osservazioni includono sia concentrazioni di inquinanti (es. PM2.5, PM10, NOx, SO2, CO, Ozone, e numerosi idrocarburi) sia variabili meteorologiche e ambientali.\\
